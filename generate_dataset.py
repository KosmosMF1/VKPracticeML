...
def main() -> None:
    ...
    for source_index, source_path in enumerate(source_files):
        ...
        for copy_index in range(args.copies_per_image):
            brightness_factor = rng.uniform(0.3, 2.0)
            contrast_factor = rng.uniform(0.3, 2.0)
            color_factor = rng.uniform(0.3, 2.0)
            ...
            rows.append(
                {
                    ...
                    "brightness_target": 1.0 / brightness_factor,
                    "contrast_target": 1.0 / contrast_factor,
                    "color_target": 1.0 / color_factor,
                }
            )
